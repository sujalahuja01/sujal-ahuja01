...
const ProjectDetails = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full backdrop-blur-sm bg-black/30">
      <motion.div
        className="relative max-w-2xl w-[90%] max-h-[90vh] overflow-y-auto border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10 no-scrollbar"
